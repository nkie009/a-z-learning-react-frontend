...
//       .sort(() => Math.random() - 0.5) //each pair item on this array. if the order returns less than 0 the order of item stay the same. if its greater than it will be swap. Math.random give you a random from 0 - 1. 
...
//   //the below is to start the game automatically 
//   useEffect(() =>{
//     shuffleCards()
//   }, [])
